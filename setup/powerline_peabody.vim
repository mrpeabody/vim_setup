...
let s:p.normal.error = [ [ 'white', 'darkred', 'bold' ] ]
let s:p.normal.warning = [ [ 'white', 'yellow', 'bold' ] ]

let g:lightline#colorscheme#powerline_peabody#palette = lightline#colorscheme#fill(s:p)
