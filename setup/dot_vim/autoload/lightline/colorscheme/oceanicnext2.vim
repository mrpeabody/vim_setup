" ============================================================
" oceanicnext2
" Based on the oceanicnext lightline theme from Mike Hartington
" ============================================================
...
let s:p.normal.right = [[["#ffffff", 15], ["#65737e", 243]], [["#d8dee9", 253], ["#343d46", 237]]]
...
let g:lightline#colorscheme#oceanicnext2#palette = lightline#colorscheme#flatten(s:p)
